...
var ae = Math.pow;
var cn = (e, t, n) => t in e ? Lo(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var se = (e, t) => {
  for (var n in t || (t = {}))
...
var D = ((e) => (e.CENTER = "center", e.NORTH = "north", e.NORTH_EAST = "north-east", e.EAST = "east", e.SOUTH_EAST = "south-east", e.SOUTH = "south", e.SOUTH_WEST = "south-west", e.WEST = "west", e.NORTH_WEST = "north-west", e))(D || {});
function Mt(e) {
  const t = {};
...
function Yo(e) {
  ...
  for (const o of n)
    watch(() => e.value[o], () => {
      mergeWith_default(t[o], e.value[o] || {}, Ko);
...
function ni(e, t, n) {
  ...
  return watchEffect(() => {
    ...
    at2(o.edgeLayoutPoints, i), at2(o.edgeGroups, s);
  }), watchEffect(() => {
    const i = {};
    for (const [s, { edges: r, groupWidth: a }] of Object.entries(o.edgeGroups)) {
      ...
      } else n.edge.summarize ? c = pn(e.value, r, n, a) : c = false;
      o.edgeGroups[s].summarize = c, c && Object.keys(r).forEach((d) => i[d] = true);
    }
    at2(o.summarizedEdges, i);
  }), o;
}
...
function ii(e, t, n) {
  ...
  for (const [a, c] of Object.entries(s)) {
    ...
    if (d === 1)
      o[h] = { edge: l, pointInGroup: 0, groupWidth: 0 }, i[a] = { edges: c, groupWidth: 0, summarize: false };
    else {
      let p = 0;
      ...
      }), i[a] = { edges: c, groupWidth: y, summarize: false };
    }
  }
...
function mi(e, t, n, o, i, s, r, a) {
  ...
  let l = false, p = false;
  {
    ...
    const E = a + (r === "edgeOfNode" ? b : 0), g = E <= 0 ? v.line.source : yn(v, E, n, true);
    h.push(g), b = We(t[v.target].shape) * i, a > 0 && ee.distance(v.line.source, v.line.target) <= E + b && (l = true);
  }
  const w = c.length;
  for (let v = 1; v < w; v++) {
  ...
  }
  {
    ...
    const E = a + (r === "edgeOfNode" ? b : 0), g = E <= 0 ? v.line.target : yn(v, E, n, false);
    if (b = We(t[v.source].shape) * i, v.loop) {
      ...
      h.push(g);
    a > 0 && ee.distance(v.line.source, v.line.target) <= E + b && (p = true);
  }
...
function Ct(e, t, n, o, i, s, r) {
  ...
  watch(
    ...
    (d, u) => {
      ...
      h.forEach((p) => {
        const w = a[p];
        w && !w.selected && (w.selected = true);
      }), l.forEach((p) => {
        const w = a[p];
        w && w.selected && (w.selected = false);
      });
    },
    { immediate: true }
    ...
    (d, u) => {
      ...
      h.forEach((p) => {
        const w = a[p];
        w && !w.hovered && (w.hovered = true);
      }), l.forEach((p) => {
        const w = a[p];
        w && w.hovered && (w.hovered = false);
      });
    }
  );
  const c = computed(() => {
...
function wi(e, t, n, o, i, s) {
  const r = {
    ...
    selected: o,
    hovered: false,
    selectable: computed(() => e.value[n] ? _.value(i.selectable, e.value[n]) : unref(r.selectable)),
    zIndex: computed(() => e.value[n] ? _.value(i.zOrder.zIndex, e.value[n]) : unref(r.zIndex))
  };
  t[n] = r, s(
    e,
    n,
...
function Oi(e, t, n, o, i, s, r, a) {
  ...
  ), l = ei(), p = ni(e.objects, t.objects, o), w = ref([]), {
    states: k,
    zOrderedList: y
    //
  } = Ct(
  ...
  const {
    ...
    (g, f, m) => {
      const x = m;
      x.clickable = computed(() => g.value[f] ? _.value(o.path.clickable, g.value[f]) : false), x.hoverable = computed(() => g.value[f] ? _.value(o.path.hoverable, g.value[f]) : false), x.path = g.value[f], x.edges = xn(x.path, t), x.directions = bn(x.edges), x.stopWatchHandle = watch(
        () => g.value[f].edges,
        () => {
  ...
  return provide(Un, E), E;
}
function zi(e) {
  return e.summarized;
}
function ke() {
  return q(inject(Un), "states");
}
function Ti(e, t, n, o) {
...
function _i(e, t, n, o, i, s, r) {
  var a, c;
  !s.nodes[t] && ((a = r.nodes) != null && a[t]) && (s.nodes[t] = se({}, (c = r.nodes) == null ? void 0 : c[t])), n.shape = computed(() => e.value[t] ? Ti(e.value[t], n.selected, n.hovered, o) : unref(n.shape)), n.staticShape = computed(() => e.value[t] ? Xn(e.value[t], n.selected, o) : unref(n.staticShape)), n.label = computed(() => e.value[t] ? _.values(o.label, e.value[t]) : unref(n.label)), n.labelText = computed(() => {
    var d, u;
    return o.label.text instanceof Function ? unref(n.label).text : e.value[t] ? (u = (d = e.value[t]) == null ? void 0 : d[unref(n.label).text]) != null ? u : "" : unref(n.labelText);
  }), n.draggable = computed(() => e.value[t] ? _.value(o.draggable, e.value[t]) : unref(n.draggable)), n.oppositeNodeIds = toRef(i, t), n.oppositeNodes = computed(() => Object.entries(n.oppositeNodeIds).reduce(
    (d, u) => {
...
function $i(e, t, n, o, i, s, r, a, c, d) {
  ...
  }), n.label = computed(() => e.value[t] ? _.values(o.label, e.value[t]) : unref(n.label));
  const l = computed(() => {
  ...
  const p = toRef(
    r.edgeLayoutPoints,
    t
  ), w = toRef(r.summarizedEdges, t), k = watchEffect(() => {
...
function Bi(e, t, n, o, i, s, r) {
  ...
  function h(g, f) {
    ...
    const m = (z = (x = e[g]) == null ? void 0 : x.selectable) != null ? z : false;
    if (m) {
  ...
  function w(g) {
    ...
    if (f) {
      for (f of a.pointers.values()) {
        const m = f.nodeId, x = lt2(g.pointerType);
        if (f.moveCounter > x) {
          const $ = u(f, {
            pointerId: f.pointerId,
  ...
  function k(g) {
    ...
    const m = f.nodeId, x = lt2(g.pointerType), z = f.moveCounter > x;
    if (z) {
...
function Vi(e, t, n, o) {
  ...
  function r(p) {
    i.moveCounter = 0, i.pointerCounter === 0 && fe(s).forEach(([w, k]) => {
      document.addEventListener(w, k, { passive: true });
    }), i.pointerCounter++;
  }
  function a(p) {
    i.moveCounter++;
  ...
  onMounted(() => {
    const p = e.value;
    p && (p.addEventListener("pointerdown", r, { passive: true }), p.addEventListener("click", d, { passive: false }), p.addEventListener("dblclick", u, { passive: false }), p.addEventListener("contextmenu", h, { passive: false }), n.value && p.addEventListener("wheel", l, { passive: false }));
  }), onUnmounted(() => {
    const p = e.value;
    ...
    const k = e.value;
    !k || p === w || (p ? k.addEventListener("wheel", l, { passive: false }) : k.removeEventListener("wheel", l));
  });
}
function Wi(e, t, n, o, i, s) {
  const r = {
  ...
  function w(v, b) {
    ...
    const E = (m = (f = e[v]) == null ? void 0 : f.selectable) != null ? m : false;
    if (E) {
...
function qi(e, t, n, o, i, s) {
  ...
  ), a = computed(() => t.viewMode.value === "box-selection"), c = ref(), d = ref(), u = {
...
function Gi(e, t, n, o, i, s, r, a) {
  ...
  if (a === "append")
    s.forEach((l) => {
      ...
      var w, k;
      const p = (k = (w = i[l]) == null ? void 0 : w.selectable) != null ? k : false;
      (p === true || typeof p == "number" && s.size < p) && s.add(l);
    });
  else {
    const l = new Set(r);
    l.forEach((p) => {
      ...
      var w, k;
      if (!r.has(p)) {
        const y = (k = (w = i[p]) == null ? void 0 : w.selectable) != null ? k : false;
        (y === true || typeof y == "number" && l.size < y) && l.add(p);
      }
...
var Yn = Symbol("mouseEventHandlers");
function Qi(e, t, n, o, i, s, r, a, c, d, u, h, l, p, w, k) {
  const y = {
    selectionMode: ref("container"),
    viewMode: ref("default")
  };
  r.size > 0 ? y.selectionMode.value = "node" : a.size > 0 ? y.selectionMode.value = "edge" : c.size > 0 && (y.selectionMode.value = "path"), watch(y.viewMode, (b) => {
    k.emit("view:mode", b);
  }), Vi(e, y, p, k);
  const v = se(se(se(se({
    selectedNodes: r,
  ...
  return provide(Yn, v), v;
}
function ot() {
  return q(inject(Yn), "mouseEventHandlers");
}
function Ji(e) {
...
var Qn = Symbol("emitter");
function es() {
  const e = Ji();
  return provide(Qn, e), e;
}
function ts() {
  return q(inject(Qn), "event emitter");
}
...
var yt = {
  ...
  throttle: function(e, t, n) {
    ...
    n || (n = {});
    var d = function() {
      c = n.leading === false ? 0 : o.now(), a = null, r = e.apply(i, s), a || (i = s = null);
    };
    return function() {
      var u = o.now();
      !c && n.leading === false && (c = u);
      var h = t - (u - c);
      return i = this, s = arguments, h <= 0 || h > t ? (clearTimeout(a), a = null, c = u, r = e.apply(i, s), a || (i = s = null)) : !a && n.trailing !== false && (a = setTimeout(d, h)), r;
    };
  },
  /**
...
ie.prototype.setCTM = function(e) {
  ...
  if (t || n) {
    if (t && (this.options.beforeZoom(
      ...
      o === false ? (e.e = this.getPan().x, e.f = this.getPan().y, i = s = true) : Ie.isObject(o) && (o.x === false ? (e.e = this.getPan().x, i = true) : Ie.isNumber(o.x) && (e.e = o.x), o.y === false ? (e.f = this.getPan().y, s = true) : Ie.isNumber(o.y) && (e.f = o.y)), i && s || !this.isPanDifferent(e) ? n = false : (this.updateCache(e), this.options.onPan(this.getPan()));
    }
...
ie.prototype.pendingUpdate = false;
...
ie.prototype.updateCTM = function() {
  var e = this.getCTM();
  rs.setCTM(this.viewport, e, this.defs), this.pendingUpdate = false, this.options.onUpdatedCTM && this.options.onUpdatedCTM(e);
};
var as = function(e, t) {
  return new ie(e, t);
};
...
X.prototype.handleTouchMove = function(e) {
  if (e.touches.length == 1)
    ...
    if (this.options.zoomEnabled) {
      ...
      this.zoomAtPoint(this.firstZoomLevel * a, d, true);
    }
  }
};
...
function ys() {
  ...
  function n(o, i = 300, s = "linear") {
    e && (clearTimeout(e), e = null), t.value = {
      ...
      duration: i,
      timingFunction: s
    }, nextTick(() => ye(this, null, function* () {
      const r = o();
...
function xs() {
  return q(inject(io), "Selections");
}
var so = Symbol("layouts");
function Ps(e) {
  provide(so, e);
}
function en() {
  return q(inject(so), "Layouts");
}
function Ss(e, t) {
...
function Cs(e, t) {
  ...
  return computed(() => {
    ...
    return Ss(o, (s, r) => {
      Ke(i, r), Ms(i, s, r);
    }), "edge-label" in t || "edges-label" in t || Ke(i, "edge-labels"), e.node.focusring.visible || Ke(i, "focusring"), e.node.label.visible === false && Ke(i, "node-labels"), e.path.visible || Ke(i, "paths"), i;
  });
}
var Sn = () => new Promise((e) => nextTick(e));
function Os(e, t) {
...
var Xs = ["id", "markerWidth", "markerHeight", "refX", "refY", "markerUnits"];
var qs = defineComponent({
  ...
  setup(e) {
    ...
    return (a, c) => a.marker.type !== "none" && a.marker.type !== "custom" ? (openBlock(), createElementBlock("marker", {
      key: 0,
      id: a.id,
      markerWidth: o.value,
      ...
      (openBlock(), createBlock(resolveDynamicComponent(t[a.marker.type]), {
        width: o.value,
        height: i.value,
        refX: s.value,
...
var er = defineComponent({
  ...
  setup(e) {
    const { container: t, svgPanZoom: n } = Vt(), { zoomLevel: o } = ge(), i = ts(), s = Qo(), r = ref({ x: 0, y: 0 }), a = ref({ width: 500, height: 500 });
    onMounted(() => {
      var w;
    ...
    }), (l, p) => (openBlock(), createElementBlock("g", Gs, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(h.value, ([w, k, y, v, b]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `nv${w}`,
        d: `M ${y} ${k} L ${v} ${k}`,
        ref_for: true
      }, b, { style: { "vector-effect": "non-scaling-stroke" } }), null, 16, Ks))), 128)),
      (openBlock(true), createElementBlock(Fragment, null, renderList(u.value, ([w, k, y, v, b]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `nh${w}`,
        d: `M ${k} ${y} L ${k} ${v}`,
        ref_for: true
      }, b, { style: { "vector-effect": "non-scaling-stroke" } }), null, 16, Ys))), 128)),
      (openBlock(true), createElementBlock(Fragment, null, renderList(d.value, ([w, k, y, v, b]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `tv${w}`,
        d: `M ${y} ${k} L ${v} ${k}`,
        ref_for: true
      }, b, { style: { "vector-effect": "non-scaling-stroke" } }), null, 16, Qs))), 128)),
      (openBlock(true), createElementBlock(Fragment, null, renderList(c.value, ([w, k, y, v, b]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `th${w}`,
        d: `M ${k} ${y} L ${k} ${v}`,
        ref_for: true
    ...
    const t = e, { scale: n } = ge(), o = mt(), {
      ...
      if (t.state.loop) {
          ...
          return `M ${l.p1.x} ${l.p1.y} L ${l.p2.x} ${l.p2.y}`;
        {
          ...
          return w.push(`M ${l.p1.x} ${l.p1.y}`), chunk_default(p, 2).forEach(([k, y]) => w.push(`Q ${k.x} ${k.y} ${y.x} ${y.y}`)), w.join(" ");
        }
      }
    }), h = computed(() => (t.state.line.stroke.width + 10) * n.value);
    return (l, p) => (openBlock(), createElementBlock("path", {
      class: normalizeClass({ "v-ng-line-background": true, selectable: l.state.selectable }),
      d: u.value,
      stroke: "transparent",
      "stroke-width": h.value,
      fill: "none",
      onPointerdown: p[0] || (p[0] = withModifiers((w) => unref(i)(l.id, w), ["stop"])),
      onPointerenterPassive: p[1] || (p[1] = (w) => unref(s)(l.id, w)),
      onPointerleavePassive: p[2] || (p[2] = (w) => unref(r)(l.id, w)),
      onClick: p[3] || (p[3] = withModifiers((w) => unref(a)(l.id, w), ["stop"])),
      onDblclick: p[4] || (p[4] = withModifiers((w) => unref(c)(l.id, w), ["stop"])),
      onContextmenu: p[5] || (p[5] = (w) => unref(d)(l.id, w))
    }, null, 42, nr));
  }
});
var ir = defineComponent({
  ...
  setup(e) {
    ...
    return (i, s) => (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n).edgeGroups, ({ summarize: r, edges: a }) => (openBlock(), createElementBlock(Fragment, null, [
      r ? createCommentVNode("", true) : (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(a, (c, d) => (openBlock(), createBlock(or, {
        key: d,
        id: d,
        state: unref(t)[d],
        "source-pos": unref(o).nodes[c.source],
        "target-pos": unref(o).nodes[c.target]
...
var uo = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = ge(), o = computed(() => t.config.width * n.value), i = computed(() => nt(t.config.dasharray, n.value)), s = computed(() => {
      const r = t.config.animate ? pt(t.config.dasharray) * t.config.animationSpeed * n.value : false;
      return r ? { "--animation-speed": r } : void 0;
    });
    return (r, a) => (openBlock(), createElementBlock("path", {
      class: normalizeClass({ "v-ng-line": true, animate: r.config.animate }),
...
var rr = ["d", "stroke", "stroke-width", "stroke-dasharray", "stroke-linecap"];
var ar = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = ge(), o = computed(() => t.config.width * n.value), i = computed(() => nt(t.config.dasharray, n.value)), s = computed(() => {
      const a = t.config.animate ? pt(t.config.dasharray) * t.config.animationSpeed * n.value : false;
...
var lr = ["d", "stroke", "stroke-width", "stroke-dasharray", "stroke-linecap", "marker-start", "marker-end"];
var cr = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = ge(), o = computed(() => {
      var u, h;
      const a = t.state.position, c = [...(h = (u = t.state.curve) == null ? void 0 : u.control) != null ? h : [], { x: a.p2.x, y: a.p2.y }], d = [];
      return d.push(`M ${a.p1.x} ${a.p1.y}`), chunk_default(c, 2).forEach(([l, p]) => d.push(`Q ${l.x} ${l.y} ${p.x} ${p.y}`)), d.join(" ");
    }), i = computed(() => t.config.width * n.value), s = computed(() => nt(t.config.dasharray, n.value)), r = computed(() => {
      const a = t.config.animate ? pt(t.config.dasharray) * t.config.animationSpeed * n.value : false;
      return a ? { "--animation-speed": a } : void 0;
    });
    return (a, c) => (openBlock(), createElementBlock("path", {
...
var ur = defineComponent({
  ...
  setup(e) {
    const t = mt();
    return (n, o) => n.state.loop ? (openBlock(), createBlock(ar, mergeProps({ key: 0 }, n.state.position, {
    ...
    }), null, 16, ["radius", "is-large-arc", "is-clockwise", "class", "config", "marker-start", "marker-end"])) : unref(t).type == "straight" || !n.state.curve ? (openBlock(), createBlock(uo, mergeProps({
      key: 1,
      "data-edge-id": n.id
    }, n.state.position, {
      class: [{ selectable: n.state.selectable, hover: n.state.hovered, selected: n.state.selected }, "v-ng-edge"],
      ...
      "marker-start": n.state.sourceMarkerId ? `url('#${n.state.sourceMarkerId}')` : void 0,
      "marker-end": n.state.targetMarkerId ? `url('#${n.state.targetMarkerId}')` : void 0
    }), null, 16, ["data-edge-id", "class", "config", "marker-start", "marker-end"])) : (openBlock(), createBlock(cr, {
      key: 2,
      "data-edge-id": n.id,
      class: normalizeClass([{ selectable: n.state.selectable, hover: n.state.hovered, selected: n.state.selected }, "v-ng-edge"]),
      state: n.state,
      config: n.state.line.stroke,
      "marker-start": n.state.sourceMarkerId ? `url('#${n.state.sourceMarkerId}')` : void 0,
      "marker-end": n.state.targetMarkerId ? `url('#${n.state.targetMarkerId}')` : void 0
...
var dr = ["cx", "cy", "r", "fill", "stroke", "stroke-width", "stroke-dasharray"];
var fr = ["x", "y", "width", "height", "rx", "ry", "fill", "stroke", "stroke-width", "stroke-dasharray"];
var wt = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = ge(), o = ref(t.baseX), i = ref(t.baseY), s = ref(0), r = ref("#000000"), a = ref(void 0), c = ref(0), d = ref(0), u = ref(0), h = ref(0);
    return watchEffect(() => {
      var p;
      const l = n.value;
    ...
    }), (l, p) => l.config.type === "circle" ? (openBlock(), createElementBlock("circle", {
      key: 0,
    ...
    }, null, 8, dr)) : (openBlock(), createElementBlock("rect", {
      key: 1,
...
var hr = ["rx", "ry", "fill", "transform"];
var pr = ["x", "y", "dominant-baseline", "font-family", "font-size", "fill"];
...
var Et = defineComponent({
  ...
  setup(e) {
    const t = e, n = useAttrs(), { scale: o } = ge(), i = computed(() => {
      var y, v;
    ...
    }), c = ref(), d = ref(""), u = reactive({ x: 0, y: 0, width: 0, height: 0 }), h = computed(() => {
      var g, f;
    ...
    return (y, v) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        y.config.background && y.config.background.visible ? (openBlock(), createElementBlock("rect", mergeProps({
          key: 0,
          class: "v-ng-text-background"
        }, h.value, {
          rx: ((E = (b = y.config.background) == null ? void 0 : b.borderRadius) != null ? E : 0) * unref(o),
          ry: ((f = (g = y.config.background) == null ? void 0 : g.borderRadius) != null ? f : 0) * unref(o),
          fill: (x = (m = y.config.background) == null ? void 0 : m.color) != null ? x : "#ffffff",
          transform: d.value
        }), null, 16, hr)) : createCommentVNode("", true),
        createBaseVNode("text", mergeProps({
          ...
          ], 64)) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(i.value, (z, $) => (openBlock(), createElementBlock("tspan", {
            key: $,
            x: y.x,
            dy: $ == 0 ? a.value : r.value,
            "dominant-baseline": y.dominantBaseline
          }, toDisplayString(z), 9, vr))), 128))
        ], 16, pr)
      ], 64);
    };
  }
...
var gr = defineComponent({
  ...
  setup(e) {
    ...
    } = ot(), { edgeStates: d } = ke(), u = ref({ p1: { x: 0, y: 0 }, p2: { x: 0, y: 0 } }), h = ref({ x: 0, y: 0 });
    watchEffect(() => {
    ...
    const l = computed(() => Object.keys(t.edges)), p = computed(() => _.values(n.summarized.label, t.edges)), w = computed(() => _.values(n.summarized.shape, t.edges)), k = computed(() => _.values(n.summarized.stroke, t.edges)), y = computed(() => l.value.some((E) => d[E].hovered)), v = computed(() => l.value.some((E) => d[E].selectable)), b = computed(() => l.value.some((E) => d[E].selected));
    return (E, g) => (openBlock(), createElementBlock("g", {
      class: normalizeClass({ "v-ng-line-summarized": true, hovered: y.value, selectable: v.value, selected: b.value }),
      onPointerdown: g[0] || (g[0] = withModifiers((f) => unref(o)(l.value, f), ["stop"])),
      onPointerenterPassive: g[1] || (g[1] = (f) => unref(i)(l.value, f)),
      onPointerleavePassive: g[2] || (g[2] = (f) => unref(s)(l.value, f)),
      onClick: g[3] || (g[3] = withModifiers((f) => unref(r)(l.value, f), ["stop"])),
      onDblclick: g[4] || (g[4] = withModifiers((f) => unref(a)(l.value, f), ["stop"])),
      onContextmenu: g[5] || (g[5] = (f) => unref(c)(l.value, f))
    }, [
      createVNode(uo, mergeProps(u.value, {
        config: k.value,
...
var mr = { class: "v-ng-edge-overlay" };
var Mn = defineComponent({
  ...
  setup(e) {
    ...
    return (u, h) => (openBlock(), createElementBlock("g", mr, [
      u.isSummarized ? renderSlot(u.$slots, "default", {
        key: 0,
        edges: u.edges,
...
var br = defineComponent({
  ...
  setup(e) {
    ...
    return (i, s) => (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n), (r) => (openBlock(), createElementBlock(Fragment, null, [
      unref(zi)(r) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        (openBlock(), createBlock(gr, {
          key: r.key,
          edges: r.group.edges,
          layouts: unref(o).nodes
        }, null, 8, ["edges", "layouts"])),
        i.hasEdgeOverlaySlot ? (openBlock(), createBlock(Mn, {
          key: r.key,
          edges: r.group.edges,
          ...
          default: withCtx((a) => [
            renderSlot(i.$slots, "default", mergeProps({ ref_for: true }, a))
          ]),
          _: 2
...
var yr = { class: "v-ng-layer-edges v-ng-graph-objects" };
var wr = defineComponent({
  __name: "VEdgesLayer",
  setup(e) {
    const t = useSlots(), n = computed(() => "edge-overlay" in t);
    return (o, i) => (openBlock(), createElementBlock("g", yr, [
      createVNode(ir),
      createVNode(br, { "has-edge-overlay-slot": n.value }, createSlots({ _: 2 }, [
        n.value ? {
          name: "default",
          fn: withCtx((s) => [
...
var Er = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = ge(), o = computed(() => Hn(
...
var Pr = defineComponent({
  ...
  setup(e) {
    const { edgeStates: t, edgeGroupStates: n, summarizedEdgeStates: o } = ke(), i = computed(() => {
      const r = {}, a = {};
    ...
    return (r, a) => (openBlock(), createElementBlock("g", xr, [
      r.enableEdgeLabel ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(i.value.individual, (c, d) => (openBlock(), createElementBlock(Fragment, { key: d }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(c.edges, (u, h) => (openBlock(), createBlock(Er, {
          key: h,
          "edge-id": h,
          edge: u,
          state: unref(t)[h]
          ...
          default: withCtx((l) => [
            renderSlot(r.$slots, "edge-label", mergeProps({ ref_for: true }, l))
          ]),
          _: 2
        }, 1032, ["edge-id", "edge", "state"]))), 128))
      ], 64))), 128)) : createCommentVNode("", true),
      r.enableEdgesLabel ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(i.value.summarized, (c, d) => (openBlock(), createBlock(kr, {
        key: d,
        edges: c.edges,
        state: unref(t)[s(c)],
        "summarize-state": unref(o)[s(c)]
      }, {
        default: withCtx((u) => [
          renderSlot(r.$slots, "edges-label", mergeProps({ ref_for: true }, u))
        ]),
        _: 2
...
var Sr = defineComponent({
  ...
  setup(e) {
    return (t, n) => (openBlock(), createBlock(Pr, {
...
var Cr = { class: "v-ng-layer-nodes-selections" };
var Or = defineComponent({
  __name: "VFocusringLayer",
  setup(e) {
    const { nodeStates: t } = ke(), { selectedNodes: n } = xs(), o = en();
    return (i, s) => (openBlock(), createElementBlock("g", Cr, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n), (r) => (openBlock(), createBlock(Mr, {
        id: r,
        key: r,
        state: unref(t)[r],
        pos: unref(o).nodes[r]
...
var Cn = defineComponent({
  ...
  setup(e) {
    ...
    return (h, l) => (openBlock(), createElementBlock("g", {
      class: normalizeClass({ "v-ng-node": true, hover: h.state.hovered, selected: h.state.selected }),
      transform: `translate(${n.value} ${o.value})`,
      onPointerdown: l[0] || (l[0] = withModifiers((p) => unref(s)(h.id, p), ["stop"])),
      onPointerenterPassive: l[1] || (l[1] = (p) => unref(r)(h.id, p)),
      onPointerleavePassive: l[2] || (l[2] = (p) => unref(a)(h.id, p)),
      onClick: l[3] || (l[3] = withModifiers((p) => unref(c)(h.id, p), ["stop"])),
      onDblclick: l[4] || (l[4] = withModifiers((p) => unref(d)(h.id, p), ["stop"])),
      onContextmenu: l[5] || (l[5] = (p) => unref(u)(h.id, p))
    }, [
      renderSlot(h.$slots, "override-node", {
        nodeId: h.id,
        scale: unref(i),
        config: h.state.shape,
        class: normalizeClass({ draggable: h.state.draggable, selectable: h.state.selectable })
      }, () => [
        createVNode(wt, {
          config: h.state.shape,
...
var Tr = defineComponent({
  __name: "VNodesLayer",
  setup(e) {
    const t = useSlots(), n = computed(() => "override-node" in t), { nodeZOrderedList: o } = ke(), i = gt2(), s = en();
    return (r, a) => n.value ? (openBlock(), createBlock(TransitionGroup, {
      key: 0,
      ...
      default: withCtx(() => [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o), (c) => (openBlock(), createBlock(Cn, {
          id: c.id,
          key: c.id,
          state: c,
          pos: unref(s).nodes[c.id]
        }, {
          "override-node": withCtx((d) => [
            renderSlot(r.$slots, "override-node", mergeProps({ ref_for: true }, d))
          ]),
          _: 2
...
var On = defineComponent({
  ...
  setup(e) {
    const t = e, n = gt2(), { edgeStates: o } = ke(), { scale: i } = ge(), {
      handleNodePointerDownEvent: s,
      handleNodePointerOverEvent: r,
      handleNodePointerOutEvent: a,
      handleNodeClickEvent: c,
    ...
    }), p = computed(() => t.state.label.direction === D.CENTER ? 0 : t.state.label.margin * i.value), w = ref(0), k = ref(0), y = ref(0), v = ref(0), b = computed(() => {
      var N;
    ...
    const x = computed(() => (C) => n.label.handleNodeEvents ? {
      pointerdown: (T) => {
...
var Zr = defineComponent({
  ...
  setup(e) {
    const t = useSlots(), n = computed(() => "override-node-label" in t), { nodeZOrderedList: o } = ke(), i = gt2(), s = en(), r = computed(() => a(o.value));
    function a(c) {
      return c.filter((d) => {
        var u;
        return d.label.visible && ((u = d.labelText) != null ? u : false);
      });
    }
    return (c, d) => n.value ? (openBlock(), createBlock(TransitionGroup, {
      key: 0,
      name: unref(i).transition,
      css: !!unref(i).transition,
      tag: "g",
      ...
      default: withCtx(() => [
        (openBlock(true), createElementBlock(Fragment, null, renderList(r.value, (u) => (openBlock(), createBlock(On, {
          id: u.id,
          key: u.id,
          state: u,
          pos: unref(s).nodes[u.id]
        }, {
          "override-node-label": withCtx((h) => [
            renderSlot(c.$slots, "override-node-label", mergeProps({ ref_for: true }, h))
          ]),
          _: 2
        }, 1032, ["id", "state", "pos"]))), 128))
      ]),
...
var Nr = defineComponent({
  ...
  setup(e) {
      ...
      return p.map((k) => {
        if (k === null)
          ...
          if (k instanceof Array) {
            ...
            return chunk_default(k, 2).map(([v, b]) => y.push(`Q ${v.x} ${v.y} ${b.x} ${b.y}`)), y.join(" ");
          } else {
            const y = w;
            return w = false, `${y ? "M " : "L "}${k.x} ${k.y}`;
          }
        }
      }).join(" ");
    }
    ...
    }), u = computed(() => nt(d.value.dasharray, s.value)), h = computed(() => {
      const l = d.value.animate ? pt(d.value.dasharray) * d.value.animationSpeed * s.value : false;
    ...
    return (l, p) => (openBlock(), createElementBlock("path", {
      ...
      "stroke-width": d.value.width * unref(s),
...
var jr = defineComponent({
  ...
  setup(e) {
    ...
    return (d, u) => (openBlock(), createBlock(TransitionGroup, {
      ...
      default: withCtx(() => [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(t), (h) => (openBlock(), createBlock(Nr, {
          key: h.id,
          path: h,
          onPointerdown: (l) => unref(o)(h.id, l),
          onPointerenterPassive: (l) => unref(i)(h.id, l),
          onPointerleavePassive: (l) => unref(s)(h.id, l),
          onClick: withModifiers((l) => unref(r)(h.id, l), ["stop"]),
          onDblclick: withModifiers((l) => unref(a)(h.id, l), ["stop"]),
          onContextmenu: (l) => unref(c)(h.id, l)
...
var Vr = defineComponent({
  ...
  setup(e, { expose: t, emit: n }) {
    const o = [
      ...
      "edge-label",
      "edges-label"
    ], i = e, s = n, r = useSlots(), a = toRef(i, "nodes"), c = toRef(i, "edges"), { objects: d, isInCompatibilityModeForPath: u } = ws(
      toRef(i, "paths")
    ), h = es();
    Object.entries(i.eventHandlers).forEach(([P, Z]) => {
      h.on(P, Z);
    });
    const l = Yo(toRef(i, "configs")), p = computed(() => {
    ...
    }), w = computed(() => l.view.grid.visible), k = computed(() => {
      const P = p.value;
      return w.value || P.background.length > 0 || P.grid.length > 0;
    }), y = Cs(l, r), v = ref(), b = ref(), E = ref(), g = ref(
      0
      /* INITIAL */
    ), f = computed(
      () => g.value !== 0
    ...
    z(() => {
      ...
      Object.assign(C, { width: A, height: V }), (Pe = E.value) == null || Pe.addEventListener("touchstart", an, { passive: false });
    }), $(() => {
      var P;
    ...
    watch(Ee, (P) => h.emit("node:select", Array.from(P)));
    const Ae = Tt(i, "selectedEdges", c, s);
    watch(Ae, (P) => h.emit("edge:select", Array.from(P)));
    const Ze = Tt(i, "selectedPaths", d, s);
    watch(Ze, (P) => h.emit("path:select", Array.from(P))), ks(Ee, Ae, Ze);
    ...
    Ps(xe), watch(
      ...
      { deep: true, immediate: true }
    ), watch(xe, () => s("update:layouts", xe), { deep: true });
    const kt = xi(), xt = ref(false);
    h.on("node:dragstart", (P) => xt.value = true), h.on("node:dragend", (P) => xt.value = false), h.on("view:mode", (P) => {
      var Z, A, V, te;
    ...
    const ho = computed(() => l.view.panEnabled || l.view.zoomEnabled || l.node.draggable), { nodeStates: po, edgeStates: vo, pathStates: go } = Oi(
      Ot(a, Ee, ce),
      Ot(c, Ae, Be),
      Ot(d, Ze, Re),
      readonly(l),
      ...
      kt,
      N
    ), mo = computed(() => Pt(l.view)), { isBoxSelectionMode: bo, selectionBox: tn, startBoxSelection: yo, stopBoxSelection: wo } = Qi(
      b,
      readonly(xe),
      readonly(m),
      po,
    ...
    const { transitionWhile: Eo, transitionOption: on } = ys(), ko = computed(() => {
      const P = on.value;
      return P.enabled ? {
    ...
    return (P, Z) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ref_key: "svg",
        ref: b,
        class: normalizeClass(["v-ng-canvas", { show: f.value, dragging: xt.value, touches: ho.value, "box-selection-mode": unref(bo) }]),
        width: "100%",
        height: "100%"
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(p.value.root, (A) => renderSlot(P.$slots, A, {
          key: A,
          scale: unref(N)
        })), 128)),
        Object.keys(unref(kt).markers).length > 0 ? (openBlock(), createElementBlock("defs", Rr, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(kt).markers, (A, V) => (openBlock(), createBlock(qs, {
            id: V,
            key: V,
            marker: A,
            scale: unref(N)
        ...
        k.value ? (openBlock(), createBlock(tr, { key: 1 }, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(p.value.background, (A) => (openBlock(), createElementBlock("g", {
              key: A,
              class: "v-ng-layer"
            }, [
              renderSlot(P.$slots, A, { scale: unref(N) })
            ]))), 128)),
            w.value ? (openBlock(), createBlock(er, { key: 0 })) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(p.value.grid, (A) => (openBlock(), createElementBlock("g", {
              key: A,
              class: "v-ng-layer"
            }, [
              renderSlot(P.$slots, A, { scale: unref(N) })
        ...
        createBaseVNode("g", {
          ref_key: "viewport",
          ref: E,
          class: normalizeClass(["v-ng-viewport", { "v-ng-transition": unref(on).enabled }]),
          style: normalizeStyle(ko.value)
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(p.value.base, (A) => (openBlock(), createElementBlock("g", {
            key: A,
            class: "v-ng-layer"
          }, [
            renderSlot(P.$slots, A, { scale: unref(N) })
          ]))), 128)),
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(y), (A) => (openBlock(), createElementBlock(Fragment, { key: A }, [
            A === "edges" ? (openBlock(), createBlock(wr, { key: 0 }, createSlots({ _: 2 }, [
              "edge-overlay" in unref(r) ? {
                name: "edge-overlay",
                fn: withCtx((V) => [
            ...
            ]), 1024)) : A === "edge-labels" ? (openBlock(), createBlock(Sr, {
              key: 1,
              ...
              _: 3
            }, 8, ["enable-edge-label", "enable-edges-label"])) : A === "focusring" ? (openBlock(), createBlock(Or, { key: 2 })) : A === "nodes" ? (openBlock(), createBlock(Tr, { key: 3 }, {
              "override-node": withCtx((V) => [
                renderSlot(P.$slots, "override-node", mergeProps({ ref_for: true }, V))
              ]),
              _: 3
            })) : A === "node-labels" ? (openBlock(), createBlock(Zr, { key: 4 }, {
              "override-node-label": withCtx((V) => [
                renderSlot(P.$slots, "override-node-label", mergeProps({ ref_for: true }, V))
              ]),
              _: 3
            })) : A === "paths" ? (openBlock(), createBlock(Br, { key: 5 })) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(p.value[A], (V) => (openBlock(), createElementBlock("g", {
              key: V,
              class: "v-ng-layer"
            }, [
        ...
        unref(tn) ? (openBlock(), createBlock(Bs, {
          key: 2,
          box: unref(tn),
...
var Xr = defineComponent({
  ...
  setup(e) {
    ...
    const a = computed(() => s.value === "central" && !t.config.background ? Xe(se({}, t.config), {
      background: {
        visible: true,
        color: "#ffffff",
        padding: {
    ...
    return (c, d) => (openBlock(), createBlock(Et, {
...
var qr = Object.freeze(Object.defineProperty({
  __proto__: null,
  VEdgeLabel: Xr,
  VLabelText: Et,
  VNetworkGraph: Vr,
