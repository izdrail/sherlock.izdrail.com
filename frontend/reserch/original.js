...
$.routes = function (a, b) {
    return {
        desktop: {
            "public": [{
                name: "public",
                state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b["public"]}}
            }, {name: "public.404", state: {url: "/404/", templateUrl: "404.html"}}, {
            ...
            anon: [{
                name: "anon",
                state: {"abstract": !0, template: "<ui-view/>", data: {access: b.anon}}
            }, {
                name: "anon.login",
                state: {
                    url: "/login/:user",
                ...
                state: {url: "/credentials", templateUrl: "views/loginSimple.html", controller: "LoginController"}
            }, {
                name: "anon.androidHelp",
                state: {url: "/androidHelp/", templateUrl: "views/android-help.html", controller: "LoginController"}
            }, {
                name: "anon.mysagemcombox",
                state: {"abstract": !0, url: "/mybox", templateUrl: "views/base.html"}
            }, {
                name: "anon.mysagemcombox.deviceInfo",
                state: {url: "/deviceInfo", templateUrl: "views/mysagemcombox.simple-main.html"}
            }, {
            ...
            user: [{
                name: "user",
                state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b.guest}}
            }, {
                name: "user.homefirst",
                state: {
                    url: "/firstAccess",
                ...
                state: {url: "/ppp", templateUrl: "views/first-access.ppp.html", controller: "PPPController"}
            }, {
                ...
                state: {url: "/finish", templateUrl: "views/first-access.end.html", controller: "EndController"}
            }, {
                name: "user.home",
                state: {
                    url: "/",
                ...
                state: {url: "/mybox", templateUrl: "views/mysagemcombox.main.html"}
            }, {
                name: "user.mysagemcombox.deviceInfo",
                state: {url: "/deviceInfo", templateUrl: "views/mysagemcombox.device-info.main.html"}
            }, {
                ...
                state: {url: "/dns", templateUrl: "views/mysagemcombox.dns.main.html"}
            }, {
                ...
                state: {url: "/log", templateUrl: "views/mysagemcombox.maintenance.log.main.html"}
            }, {
                ...
                state: {url: "/firstInstall", templateUrl: "views/mysagemcombox.maintenance.first-install.html"}
            }, {
                ...
                state: {url: "/monitor", templateUrl: "views/mysagemcombox.monitor.main.html"}
            }, {
                ...
                state: {url: "/ecoMode", templateUrl: "views/mysagemcombox.eco-mode.html", controller: "LEDController"}
            }, {
                name: "user.mysagemcombox.led",
                state: {url: "/led", templateUrl: "views/mysagemcombox.led.html", controller: "LEDController"}
            }, {
                ...
                name: "user.ethernet",
                state: {url: "/ethernet", templateUrl: "views/ethernet.html", controller: "EthernetController"}
            }, {
                name: "user.wifi",
                state: {
                    url: "/wifi/:radio/:mode",
                ...
                state: {url: "/environment", templateUrl: "views/wifi.environment.main.html"}
            }, {
                ...
                state: {url: "/guest", templateUrl: "views/wifi.guest.html"}
            }, {
                name: "user.wifi.wds",
                state: {url: "/wds", templateUrl: "views/wifi.wds.html"}
            }, {
                name: "user.accessControl",
                state: {url: "/access-control", templateUrl: "views/access-control.main.html"}
            }, {
                name: "user.accessControl.dmz",
                state: {url: "/dmz", templateUrl: "views/access-control.dmz.html", controller: "DMZController"}
            }, {
                ...
                state: {url: "/upnp", templateUrl: "views/access-control.upnp.html", controller: "UPnPController"}
            }, {
                name: "user.accessControl.parentalControl",
                state: {url: "/parental-control", templateUrl: "views/access-control.parental-control.main.html"}
            }, {
                ...
                state: {
                    ...
                    data: {module: "portTriggering"}
                }
            }, {
                name: "user.accessControl.certificates",
                state: {url: "/certificates", templateUrl: "views/access-control.certificates.main.html"}
            }, {
                name: "user.accessControl.certificates.local",
                state: {url: "/local", templateUrl: "views/access-control.certificates.local.html"}
            }, {
                name: "user.accessControl.certificates.remote",
                state: {url: "/remote", templateUrl: "views/access-control.certificates.remote.html"}
            }, {
                name: "user.accessControl.vpn",
                state: {url: "/vpn", templateUrl: "views/access-control.vpn.main.html"}
            }, {
                name: "user.accessControl.vpn.lt2p",
                state: {url: "/lt2p", templateUrl: "views/access-control.vpn.lt2p.html"}
            }, {
                name: "user.accessControl.vpn.ipsec",
                state: {url: "/ipSec", templateUrl: "views/access-control.vpn.ipsec.html"}
            }, {
                ...
                name: "user.plcDevice",
                state: {url: "/plc/:uid", templateUrl: "views/plc.device-info.html", controller: "PlcDeviceController"}
            }, {
                name: "user.usbDevice",
                state: {
                    url: "/usb-devices/:uid",
                ...
                state: {url: "/route", templateUrl: "views/mysagemcombox.route.main.html", data: {module: "route"}}
            }, {
                ...
                state: {url: "/myMedia", templateUrl: "views/my.media.html", controller: "MyMediaController"}
            }, {
                name: "user.mycloud",
                state: {url: "/mycloud", templateUrl: "views/mycloud.main.html"}
            }, {
                name: "user.mycloud.login",
                state: {url: "/login", templateUrl: "views/mycloud.login.html", controller: "MyCloudController"}
            }, {
                name: "user.mycloud.dropbox",
                state: {url: "/dropbox", templateUrl: "views/mycloud.dropbox.html", controller: "MyCloudController"}
            }, {
                name: "user.phonebook",
                state: {url: "/phonebook", templateUrl: "views/phonebook.main.html"}
            }, {
                ...
                state: {url: "/answering-machine", templateUrl: "views/answering-machine.main.html"}
            }, {
                ...
                state: {
                    ...
                    data: {module: "mailServerSettings"}
                }
            }, {
                ...
                state: {url: "/internetConnectivity", templateUrl: "views/internet-connectivity.main.html"}
            }, {
                name: "user.internetConnectivity.ppp",
                state: {url: "/ppp", templateUrl: "views/internet-connectivity.ppp.html", controller: "PPPController"}
            }, {
                ...
                state: {
                    ...
                    data: {module: "internetConnectivityWanAdvanced"}
                }
            }, {
                ...
                state: {url: "/qos", templateUrl: "views/internet-connectivity.qos.main.html", data: {module: "qos"}}
            }, {
                ...
                state: {
                    ...
                    data: {module: "internetConnectivityWanBasic"}
                }
            }, {
                ...
                state: {url: "/ipv6", templateUrl: "views/internet-connectivity.ipv6.html"}
            }, {
                ...
                state: {
                    ...
                    templateUrl: "views/mysagemcombox.bridge-mode.html",
                    controller: "BridgeModeController",
                    data: {module: "bridgemodeInternetPage"}
                }
            }, {
                name: "user.sip",
                state: {url: "/sip-settings", templateUrl: "views/sip-settings.main.html", data: {module: "sip"}}
            }, {
                ...
                name: "user.inTwo",
                state: {url: "/inTwo", templateUrl: "views/intwo-main.html"}
            }, {
                name: "user.webradio",
                state: {url: "/web-radio", templateUrl: "views/webradio.html"}
            }, {
                name: "user.inTwo.device",
                state: {url: "/device", templateUrl: "views/intwo-device.html"}
            }, {
                name: "user.inTwo.settings",
                state: {url: "/settings", templateUrl: "views/intwo-settings.html"}
            }, {
                name: "user.dect",
                state: {url: "/dect", templateUrl: "views/dect.main.html"}
            }, {
                name: "user.dect.basic",
                state: {url: "/basic", templateUrl: "views/dect.basic.html", controller: "DectBasicController"}
            }, {
            ...
            admin: [{name: "admin", state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b.admin}}}],
            onu: [{name: "onu", state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b.admin}}}],
            internal: [{
                name: "internal",
                state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b.internal}}
            }],
            poweruser: [{
                name: "poweruser",
                state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b.internal}}
            }],
            mso: [{name: "mso", state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b.mso}}}],
            voip: [{name: "voip", state: {"abstract": !0, templateUrl: "views/base.html", data: {access: b.voip}}}]
        }, mobile: {}
    }
};
var profile = {
    talktalk: {
        ...
        modules: {
            ...
            phonebook: {allowDuplicatedNumber: !0},
            useNewDHCPXpath: !1,
            hasMenuVertical: !1,
            myBox: {
                deviceInfo: {modelName: !1, maxLines: 2},
                deviceTypes: [{type: "MISCELLANEOUS", icon: "miscellaneous"}, {
                    type: "COMPUTER",
                    icon: "pc"
                }, {type: "PHONE", icon: "smartphone"}, {type: "NETWORKACCESSPOINT", icon: "nap"}, {
                    type: "AUDIOVIDEO",
                    icon: "audiovideo"
                }, {type: "NOTEBOOKS", icon: "notebook"}, {type: "GAMECONSOLE", icon: "game"}, {
                    type: "BLACKLISTED",
                    icon: "blacklisted"
                }, {type: "PRINTER", icon: "printer"}, {type: "TABLET", icon: "tablet"}, {
                    type: "TV_DECODER",
                    icon: "tv"
                }, {type: "WIFI_BRIDGE", icon: "wifibridge"}, {type: "Camera", icon: "camera"}, {
                    type: "WIFI_REPEATER",
                    icon: "wifirepeater"
                }],
                dhcp: {
                ...
                statistics: {accordion: !0, ethernetBitrate: "AUTO"},
                maintenance: {horizontalTabs: !1}
            },
            wifi: {
                dual: !1,
                ...
                wifi5: {
                    ...
                    blockedChannelsByBandwidth: {"40MHZ": [140], "80MHZ": [132, 136, 140]}
                },
                wps: {configMethodXpath: "configMethodsSupported", overrideMethods: null},
                oneRequestOnly: !1,
            ...
            phonebookImport: {permittedUrls: ["f5360", "f5360.home", "192.168.1.1"]},
            accessControl: {
                parentalControlService: "ParentalControl",
                remoteAccess: {blockedModes: ["ssh"]},
                user: {editHierarchy: {}},
                gatewayTime: !1,
                removeUPNPRules: !1,
                removeUPNPIGd: !0
            ...
            tvBox: {name: ""},
            powerDigitAfter: {enable: !0},
            dsl: {displayVlanIdVDSL: !0}
        },
        showedpages: {
            lanIpv6AddressAutoconfiguration: {enable: !0},
            tabGeneral: {enable: !0},
            firewallButtonsCustom: {enable: !1},
            driverVersion: {enable: !1},
            charter5280: {enable: !1},
            wifibackhaul: {enable: !1},
            talktalk: {enable: !0},
            quickSetupWizard: {enable: !1},
            sunrise: {enable: !1},
            internetUtilitiesTR69: {enable: !1},
            landPage: {enable: !1},
            firstInstall: {enable: !1},
            firstInstallMaintenance: {enable: !1},
            firstInstallWizard: {enable: !1},
            duplexMode: {enable: !1},
            checkValidHost: {enable: !1},
            mobile: {enable: !0},
            mobileLinks: {enable: !0},
            logo: {enable: !0},
            logoLinkToSagemcom: {enable: !1},
            logoWait: {enable: !0},
            modelAndFirmwareVersionHeader: {enable: !1},
            mobileWifiSchedule: {enable: !0},
            mobileWifiStrength: {enable: !0},
            mobileGuest: {enable: !0},
            mobileMyMedia: {enable: !1},
            intwo: {enable: !0},
            webradio: {enable: !1},
            myCloud: {enable: !1},
            qrCodes: {enable: !1},
            ...
            voipLink: {enable: !1},
            phonebook: {enable: !1},
            phonebookcall: {enable: !1},
            callLogCallOption: {enable: !0},
            phonebookAddShowNumber: {enable: !0},
            answeringMachine: {enable: !0},
            sip: {enable: !0},
            lineDetails: {enable: !0},
            telephoneMatrix: {enable: !0},
            showTabTelephoneMatrix: {enable: !0},
            callSettings: {enable: !1},
            callForwarding: {enable: !0},
            callForwardingVoicemail: {enable: !1},
            callSettingsDebug: {enable: !0},
            callSettingsAdvanced: {enable: !0},
            callSettingsAdvancedStatus: {enable: !1},
            callWaitingAdvanced: {enable: !1},
            manageLineURI: {enable: !0},
            ecoMode: {enable: !1},
            route: {enable: !0},
            monitoring: {enable: !1},
            lanIpv6: {enable: !1},
            dhcppdSection: {enable: !0},
            lanIpv4: {enable: !0, rename: "DHCP"},
            dhcpEnable: {enable: !0},
            natSettings: {enable: !1},
            lanIpv4TvPool: {enable: !1},
            ipReservation: {enable: !0},
            ipLeaseTime: {enable: !1},
            restoreDhcp: {enable: !1},
            restoreConfig: {enable: !0},
            datapump: {enable: !1},
            statistics: {enable: !1},
            statisticsLan: {enable: !0},
            statisticsWanLayer3: {enable: !0},
            statisticsWanLayer2: {enable: !0},
            statisticsWanLayer1: {enable: !0},
            statisticsWanFTTH: {enable: !0},
            cableModemConnection: {enable: !1},
            cableModemConfiguration: {enable: !1},
            dhcpLeases: {enable: !1},
            dhcpIPv6InDHCP: {enable: !1},
            routerAdvertisementConfig: {enable: !1},
            arpTable: {enable: !1},
            myMedia: {enable: !1, rename: "Media"},
            myMediaExtras: {enable: !1},
            bkpRestore: {enable: !0},
            firmwareUpgrade: {enable: !0},
            ntp: {enable: !0},
            tr69: {enable: !0},
            tr069SSLAuthentication: {enable: !1},
            internetUtilities: {enable: !1},
            logs: {enable: !0},
            securitylog: {enable: !1},
            upnplog: {enable: !1},
            operatorlog: {enable: !0},
            systemLog: {enable: !1},
            ping: {enable: !0},
            dnsQuery: {enable: !0},
            traceroute: {enable: !0},
            hasDestinationInTraceRoute: {enable: !1},
            healthCheck: {enable: !1},
            parentalControl: {enable: !1},
            parentalControlTimeslot: {enable: !1},
            parentalControlDevice: {enable: !1},
            portTriggering: {enable: !1},
            firewall: {enable: !0},
            firewallDevice: {enable: !0},
            firewallRespondToPing: {enable: !0},
            ipv6Pinholling: {enable: !1},
            firewallIPv6: {enable: !1},
            firstIPv6DNS: {enable: !0},
            secondIPv6DNS: {enable: !0},
            certificates: {enable: !1},
            VPN: {enable: !1},
            parentalControlOlfeo: {enable: !0},
            gamesAndApps: {enable: !0},
            selectUserPasswordChange: {enable: !0},
            internetConnectivityWanAdvanced: {enable: !1},
            internetConnectivityWanBasic: {enable: !0, rename: "Basic"},
            ipv4IptvSection: {enable: !1},
            ipv4VoipSection: {enable: !1},
            forceEditConnectionType: {enable: !0},
            manageVLAN: {enable: !0},
            vpivci: {enable: !0},
            vlandId: {enable: !0},
            trafficSpeed: {enable: !1},
            trafficSpeedGauge: {enable: !0},
            qos: {enable: !1},
            "3gLTEBackup": {enable: !0},
            docsis: {enable: !0},
            docsisRfparams: {enable: !1},
            docsisMTA: {enable: !1},
            backup3gLTE: {enable: !1, implementation: "hsxpalte"},
            enableBackup3gLTE: {enable: !1},
            dongleVersionBackup3g: {enable: !1},
            simpleIpv4: {enable: !0},
            authMethod3G: {enable: !0},
            pukCode3G: {enable: !0},
            simpleIpv6: {enable: !1},
            simpleIPv6Main: {enable: !1},
            ipv6: {enable: !1},
            DHCPv6Server: {enable: !1},
            wakeOnLan: {enable: !0},
            lanVlan: {enable: !0},
            wifi5g: {enable: !0},
            wifi24g: {enable: !0},
            ...
            wifiWPS: {enable: !0},
            wifiStats: {enable: !1},
            wifiAdvanced: {enable: !0},
            wifiCountry: {enable: !1},
            wifiTransmitPower: {enable: !1},
            wifiMacFilter: {enable: !0},
            wifiIsolation: {enable: !1},
            cyclicPrefix: {enable: !1},
            wirelessEnvironment: {enable: !1},
            wirelessRecommendedChannel: {enable: !1},
            communSettingsGuest: {enable: !1},
            wirelessFullAdvanced: {enable: !1},
            wirelessScheduling: {enable: !1},
            wirelessGuestSSID: {enable: !1},
            wirelessWDS: {enable: !1},
            wirelessMSO: {enable: !1},
            remoteAccess: {enable: !1},
            remoteAccessLanOption: {enable: !1},
            remoteAccessWifiOption: {enable: !1},
            remoteAccessWanOption: {enable: !1},
            remoteAccessTrustedIP: {enable: !1},
            remoteAccessVoipOption: {enable: !1},
            remoteAccessVoipAddress: {enable: !1},
            userAccess: {enable: !0},
            userAccessMaintenance: {enable: !1},
            remoteAccessChangeUser: {enable: !0},
            dns: {enable: !0},
            showdnsinfo: {enable: !0},
            led: {enable: !0},
            ledMode: {enable: !1},
            dyndns: {enable: !0},
            portForwarding: {enable: !0},
            portForwardNatButton: {enable: !1},
            portForwardingDevice: {enable: !0},
            portForwardingUpnpReadOnly: {enable: !0},
            dmz: {enable: !0},
            dmzDevice: {enable: !0},
            natMapping: {enable: !0},
            sipDebug: {enable: !1},
            sipRegistrationExpireTimeout: {enable: !0},
            sipForceDtmfBand: {enable: !0},
            sipFlashHookEnable: {enable: !0},
            autodimming: {enable: !1},
            gpon: {enable: !0},
            wifiSignalStrength: {
                enable: !0
            },
            internetSpeed: {enable: !0},
            dectSchedule: {enable: !1},
            wifiSchedule: {enable: !1},
            ledsSchedule: {enable: !1},
            passwordTipLogin: {enable: !1},
            slideShowTitleLogin: {enable: !0},
            displayLoginSlideShow: {enable: !0},
            loginTitle: {enable: !1},
            usb: {enable: !1},
            usbEjectButton: {enable: !1},
            wpsMode: {enable: !1},
            bridgemode: {enable: !1},
            bridgemodeInternetPage: {enable: !1},
            bridgeModeConnectionType: {enable: !1},
            trafficHistory: {enable: !0},
            lte3gBackupApnParams: {enable: !0},
            quickView: {enable: !0},
            lineCallHistory: {enable: !0},
            ringTest: {enable: !0},
            mailServerSettings: {enable: !1},
            wifiTV: {enable: !1},
            walledGarden: {enable: !1},
            dmzIPv6: {enable: !1},
            ipv6DefaultRangeAddress: {enable: !1},
            deviceInfoPreLogin: {enable: !0},
            stbManufaturer: {enable: !0},
            statisticsSFP: {enable: !0},
            massStorageUSB: {enable: !1},
            wifi24Schedule: {enable: !1},
            wifi5Schedule: {enable: !1},
            wifiDualTabs: {enable: !1},
            homeWiFiMerge: {enable: !1},
            headerControlsWifi: {enable: !1},
            showAddressingTypeSelect: {enable: !0},
            PPPoePassthrough: {enable: !1},
            loginOte: {enable: !1},
            nowifi: {enable: !0},
            isCable: {enable: !1},
            dnsIPv6: {enable: !0},
            ...
            dns1IPv4: {enable: !0},
            dns2IPv4: {enable: !0},
            wifiGuestRecommendChannel: {enable: !0},
            showIPSecPPTP: {enable: !1},
            CPULoadField: {enable: !1},
            memoryField: {enable: !1},
            usDsDisplay: {enable: !0},
            globalSip: {enable: !1},
            portMirror: {enable: !1},
            ssidCreation: {enable: !1},
            pingInterface: {enable: !1},
            advancedVoIPSettings: {enable: !0},
            isSiminn: {enable: !1},
            masmovil: {enable: !1},
            mptcp: {enable: !1},
            dhcpEnablev6: {enable: !1},
            ianaEnable: {enable: !1},
            IAPDEnable: {enable: !1},
            ulaIPv6Enabled: {enable: !1},
            lanIPv6LinkLocal: {enable: !0},
            ianaManualPrefixes: {enable: !1},
            DTMFTransmissionMode: {enable: !1},
            networkConfiguration: {enable: !1},
            wirelessEnableATF: {enable: !1},
            rejectRuleEnable: {enable: !1},
            statusBackup3gLTE: {enable: !0},
            mobTechStatusBackup3gLTE: {enable: !0},
            apnBackup3g: {enable: !1},
            daylightSavingTime: {enable: !1},
            wifi24Speed: {enable: !0},
            wifi5Speed: {enable: !0},
            DLNA: {enable: !0},
            MTU: {enable: !1},
            connectionServices: {enable: !1},
            pinCode3g: {enable: !0},
            busyOnBusy: {enable: !0},
            statusReason: {enable: !0},
            lineCallWaiting: {enable: !0},
            lineMailbox: {enable: !0},
            networkSettings: {enable: !1},
            ledDimmedMode: {enable: !1},
            antennaSettings: {enable: !1},
            displayPassword: {enable: !0},
            validateBlacklistedPort: {enable: !1},
            ipv4OnlineDuration: {enable: !0},
            ipVersionStatus: {enable: !0},
            statusDDns: {enable: !0},
            statisticsEthenet: {enable: !1},
            statisticsType: {enable: !1},
            enableWMM: {enable: !0},
            wifiShowCurrentBandwidth: {enable: !1},
            lanPort4BridgeModeConfirmMsg: {enable: !0},
            licenses: {enable: !1},
            mobileOpBackup3g: {enable: !1},
            imsiBackup3g: {enable: !1},
            msisdnBackup3g: {enable: !1},
            imeiDeviceInfo: {enable: !1},
            hostnameReadOnly: {enable: !1},
            myMediaHiddenSharedName: {enable: !1},
            layerInterfaceMainPage: {enable: !1},
            showlte: {enable: !1},
            avoidValidateOnAddReserveIP: {enable: !0}
        },
        globals: {
            mySagemcomBox: {
            ...
            welcome: {EN: "Welcome to", FR: "TODO", SPN: "TODO", DE: "TODO", IT: "TODO", DA: "TODO", AR: "TODO"},
            pleaseWaitLoading: {
            ...
            pleaseWaitLoadingTop: {EN: "", FR: "TODO", SPN: "TODO", DE: "TODO", IT: "TODO", DA: "TODO", AR: "TODO"},
            pleaseWaitButton: {
                EN: "Please Wait...",
                FR: "TODO",
                SPN: "TODO",
                ...
                desktop: {
                    "public": [{
                        ...
                        state: {
                            ...
                            data: {access: a["public"]}
                        }
                    }, {
                        name: "public.404",
                        state: {url: "/404/", templateUrl: "404.html"}
                    }, {
                        name: "public.blockedAccess",
                        state: {
                            url: "/blockedAccess/",
                    ...
                    anon: [{
                        name: "anon",
                        state: {"abstract": !0, template: "<ui-view/>", data: {access: a.anon}}
                    }, {
                        name: "anon.login",
                        state: {
                            url: "/login/:user",
                    ...
                    user: [{
                        name: "user",
                        state: {"abstract": !0, templateUrl: "views/base-simple-talktalk.html", data: {access: a.guest}}
                    }, {
                        name: "user.simple",
                        state: {url: "/simple", "abstract": !0, templateUrl: "views/baseSimple.html"}
                    }, {
                        ...
                        state: {
                            url: "/internet",
                            controller: "ConnectedDevicesController",
                            data: {title: "my_internet_connection"},
                    ...
                    admin: [{
                        name: "admin",
                        state: {"abstract": !0, templateUrl: "views/base.html", data: {access: a.admin}}
                    }],
                    onu: [{
                        name: "onu",
                        state: {"abstract": !0, templateUrl: "views/base.html", data: {access: a.admin}}
                    ...
                    internal: [{
                        name: "internal",
                        state: {"abstract": !0, templateUrl: "views/base.html", data: {access: a.internal}}
                    }],
                    poweruser: [{
                        name: "poweruser",
                        state: {"abstract": !0, templateUrl: "views/base.html", data: {access: a.internal}}
                    }],
                    mso: [{name: "mso", state: {"abstract": !0, templateUrl: "views/base.html", data: {access: a.mso}}}]
                }
            }
        },
        replaceXpaths: {
...
if ("undefined" != typeof module && module.exports) exports.allProfiles = ["myrepublic", "optus", "dtag_gpon", "dtag_gfast", "dtag_xdsl", "bell", "bthome", "sunrise", "telstra", "maelstrom", "tim", "demo", "charter", "charter_5280", "windstream", "sonne", "oneboxpt", "telus", "teo", "talktalk", "myrepublic_australia", "siminn", "comhem", "maelstrom_cable", "bouygues_extender", "tlc", "get", "ssc", "proximus_f5380", "tim_v2", "demo_gpon", "telia_eth", "telia_eth_debug", "tim_f5360", "oi_f5655", "eole", "telia_air", "verizon", "orange_f5688t", "masmovil_gpon", "totalplay", "clarop"], exports.availableProfiles = ["talktalk"], exports.currentVersion = currentVersion; else {
    ...
    if ($.config.subProfiles && $.config.subProfiles.length > 0 && $.each($.config.subProfiles, function (a, b) {
        return $.configs[b.name] && $.isFunction(b.condition) && b.condition() ? (subProfile = $.configs[b.name], selectedProfile = b.name, !1) : void 0
    }), subProfile ? ($.config = subProfile, $.config.isSubProfile = !0) : delete $.config.subProfile, $.config.countries = $.configs.countries, delete $.configs, delete $.xmo.getModel, !$.isEmptyObject($.config.globals)) for (var x in $.config.globals) $.globals[x] = $.config.globals[x];
    $.isEmptyObject($.config.replaceXpaths) || $.util._replaceXpathRecursive($.config.replaceXpaths, $.xpaths), $.config.title && (document.title = $.config.title), $.util.hasFeature("dtagXdsl") && (document.title = "F@st5352 VRX517 B" === document.title ? "Speedport Plus Bonding" : "Speedport Plus")
}